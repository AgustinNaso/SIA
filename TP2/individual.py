...
class Individual:  # W0 W1 W2 w11 w12 w13 w21 w22 w23 w01 w02
    ...
    def get_best_fitness(self, other):
        return self if self.fitness < other.fitness else other

    def get_worst_fitness(self, other):
        return self if self.fitness > other.fitness else other
    ...
    def get_fitness(self):
        ...
        return fitness
        # total = math.pow(self.zeta[0] - self.f(self.xi[0]), 2) + math.pow(self.zeta[1] - self.f(self.xi[1]), 2) + math.pow(self.zeta[2] - self.f(self.xi[2]),2)
        # return total
